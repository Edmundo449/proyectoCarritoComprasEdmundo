...
<html>
    <head>
        <title>Seleccionar una Marca para agregar un nuevo producton</title>
        <meta charset="UTF-8">
    ...
    <body>
		...
		<div class="container" style="background-image: url(img/01.jpg);">
            <div class="jumbotron" style="background-image: url(img/00.jpg);">
                ...
                <div class="h3">
                    Para utilizar un producto en las cotizaciones, primero se debe a&ntilde;adir a la base de datos
                </div>
                <div class="h4">
                    ...
                    <tbody>
                        <?php while ($f = $res->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="producto_agregar.php?marca_id=<?php echo $f['marca_id']?>&marca_nombre=<?php echo $f['marca_nombre'] ?>"><?php echo $f['marca_nombre'] ?></a>
                                </td>
                            </tr>
                            <?php
                        }
